...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2020 at 04:32 AM
...
(4, 'Npd_000004', '2020-07-12', 25000, 125000, 'Belum Lunas');
...
(21, 'Npd_000004', '111', 25000, 'debit'),
(22, 'Npd_000004', '121', 25000, 'kredit'),
(23, 'Npd_000005', '111', 100000, 'debit'),
(24, 'Npd_000005', '121', 325000, 'debit'),
(25, 'Npd_000005', '421', 500000, 'kredit');
...
('Npd_000004', '2020-07-08', 'Ssw_000013', 500000, 325000, 100000, '', 'Belum Lunas'),
('Npd_000005', '2020-07-12', 'Ssw_000014', 100000, 100000, 325000, '', 'Belum Lunas');
...
('Ssw_000014', '2020-07-12', '1099', 'Rinda', 'Gorontalo', '', 'Perempuan', '2020-02-05', 'Cihampelas Indah', 'Dio', 'Rania', '90909', 0, 'Siswa', 5);
...
('Npd_000005', 'tata usaha', 'pendaftaran', '2020-07-12'),
...
--
ALTER TABLE `jurnal`
  MODIFY `no_jurnal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
