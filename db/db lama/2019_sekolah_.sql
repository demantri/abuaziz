...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Jul 2020 pada 19.51
...
('Dfu_000003', 'Ssw_000012', 'kelas 1', 1000000, 1000000, 0, 'Lunas'),
('Dfu_000004', 'Ssw_000013', 'kelas 2', 700000, 700000, 0, 'Lunas');
...
(9, 'Dfu_000002', '111', 500000, 'debit'),
(10, 'Dfu_000002', '422', 500000, 'kredit'),
(11, 'SPP_000002', '111', 800000, 'debit'),
(12, 'SPP_000002', '411', 800000, 'kredit'),
(13, 'Npd_000003', '111', 500000, 'debit'),
(14, 'Npd_000003', '421', 500000, 'kredit'),
(15, 'Dfu_000003', '111', 1000000, 'debit'),
(16, 'Dfu_000003', '422', 1000000, 'kredit'),
(17, 'SPP_000003', '111', 800000, 'debit'),
(18, 'SPP_000003', '411', 800000, 'kredit'),
(19, 'Npd_000004', '111', 500000, 'debit'),
(20, 'Npd_000004', '421', 500000, 'kredit'),
(21, 'Dfu_000004', '111', 700000, 'debit'),
(22, 'Dfu_000004', '422', 700000, 'kredit');
...
(3, 'Ssw_000012', 'kelas 1'),
(4, 'Ssw_000013', 'kelas 2');
...
('Npd_000003', '2020-07-07', 'Ssw_000012', 500000, 500000, 0, '', 'Lunas'),
('Npd_000004', '2020-07-07', 'Ssw_000013', 500000, 500000, 0, '', 'Lunas');
...
('Ssw_000012', '2020-07-07', '12345', 'izzuramadhani', 'Slawi', '', 'Perempuan', '2020-06-16', 'Semarang', 'Suhi', 'Tin Suprihatin', '086657789234', 0, 'Siswa', 5),
('Ssw_000013', '2020-07-07', '12346', 'Imelda Nur', 'Soreang ', '', 'Perempuan', '2020-05-31', 'Semarang', 'Suihihi', 'Pripri', '086789876623', 0, 'Siswa', 5);
...
('SPP_000002', 'Ssw_000011', 800000, 'July'),
('SPP_000003', 'Ssw_000012', 800000, 'July');
...
('Dfu_000002', 'tata usaha', 'daftar ulang', '2020-07-07'),
('Dfu_000003', 'tata usaha', 'daftar ulang', '2020-07-07'),
('Dfu_000004', 'tata usaha', 'daftar ulang', '2020-07-07'),
('Npd_000001', 'tata usaha', 'pendaftaran', '2020-07-06'),
('Npd_000002', 'tata usaha', 'pendaftaran', '2020-07-06'),
('Npd_000003', 'tata usaha', 'pendaftaran', '2020-07-07'),
('Npd_000004', 'tata usaha', 'pendaftaran', '2020-07-07'),
('SPP_000001', 'tata usaha', 'spp', '2020-07-06'),
('SPP_000002', 'tata usaha', 'spp', '2020-07-07'),
('SPP_000003', 'tata usaha', 'spp', '2020-07-07');
...
--
ALTER TABLE `jurnal`
  MODIFY `no_jurnal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT untuk tabel `kelas`
--
ALTER TABLE `kelas`
  MODIFY `no_kelas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
