...
*/
$url = '';
$first_url  = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'].'/assets/plugin/tinymce/plugins';
$second_url = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'].'/'.explode('/', parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH))[1].'/assets/plugin/tinymce/plugins';
$domain = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'];
// echo 'test : '.strpos($domain,'.');
...
$config = array(
	...
	*/
	'base_url' => $url,
	// 'base_url' => "http://rsj.jabarprov.go.id/assets/plugin/tinymce/plugins",
