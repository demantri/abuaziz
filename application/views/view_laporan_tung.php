	...
	<div class="sparkline13-list">
		...
		<div class="sparkline13-graph">
			<div class="datatable-dashv1-list custom-datatable-overright">
				<form action="#" class="js-form-laporan-tung form" id="form-laporan-tung">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="display:none" id="modal-laporan-tung">
	<div class="sparkline13-list">
		<div class="sparkline13-hd">
			<div class="main-sparkline13-hd">
				<h1 id="form-title"></h1>
		...
		<div class="sparkline13-graph">
			<div class="datatable-dashv1-list custom-datatable-overright">
				<div class="table-responsive" id="get-laporan-tung"> 
				</div>
			</div>
		</div>
	</div>
...
$('#total_pengeluaran').number( true, 0,'', '' );
	...
	new window.JustValidate('.js-form-laporan-tung', {
        rules: {
            bulan: {
                required: true
            },
        ...
        submitHandler: function (form, values, ajax) {
			var url = "<?= site_url('laporan_tung/get_laporan_tung'); ?>";
			var formData = new FormData($("#form-laporan-tung")[0]);
			// formData.append('content', content);
			$('#modal-laporan-tung').fadeIn('slow');
			$.ajax({
			  url: url,
			  type : 'POST',
			  method: "POST",
