            ...
            <div class="content-error">
                <div class="hpanel">
                    <div class="panel-body" >
                        <form action="#" class="js-form form form-signin" id="form-login" >
                            <div class="form-group">
                                <label class="control-label" for="username">Username</label>
                                <input type="text" class="form-control form-control-lg" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" data-validate-field="name" name="username" id="username" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="password">Password</label>
                                <input type="password" class="form-control form-control-lg" placeholder="Password" aria-label="Password" aria-describedby="basic-addon1" data-validate-field="password" name="password" id="password" autocomplete="off">
                            </div>
                            <div class="checkbox login-checkbox">
                                
                            </div>
                            <button class="btn btn-success btn-block loginbtn" id="btn-simpan">Login</button>
                        </form>
                    </div>
                </div>
            </div>
...
<script>
    new window.JustValidate('.js-form', {
        ...
        messages: {
          ...
          password: 'Form Tidak Boleh Kosong'
        },
            ...
            $.ajax({
              ...
              success: function(response) {
                if(response.status =="benar") {
                    ...
                    setTimeout(function(){ window.location.href = "<?php echo site_url('dashboard'); ?>"; },2000);
