...
{
    var $column_order = array(null, 'no_akun','nama_akun','jenis_akun'); //set column field database for datatable orderable
	var $column_search = array('no_akun','nama_akun','jenis_akun'); //set column field database for datatable searchable 
    ...
    {
        $get_no_transaksi = $this->db->query("select max(right(no_akun,6)) as max_id from akun");
		$kd = "";
