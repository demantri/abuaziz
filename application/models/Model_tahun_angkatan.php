...
{
    var $column_order = array(null, 'nama_ajaran','harga_ajaran'); //set column field database for datatable orderable
	var $column_search = array('nama_ajaran','harga_ajaran'); //set column field database for datatable searchable 
	var $order = array('no_ajaran' => 'asc'); // default order 
    ...
    {
        $get_no_transaksi = $this->db->query("select max(right(no_ajaran,6)) as max_id from tahun_ajaran");
		$kd = "";
